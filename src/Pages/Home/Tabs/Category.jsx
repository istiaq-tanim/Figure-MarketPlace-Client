...
const Category = () => {
    ...
    return (
        <div className='w-[90%] mx-auto my-10'>
            <h3 className='text-center my-5 font-bold text-3xl text-sky-500'>Shop By Category</h3>
            <Tabs defaultIndex={0}>
                <TabList className="lg:flex space-x-2 justify-center rounded-xl bg-blue-300 p-2">
                ...
                <TabPanel >
                    <div className='lg:grid grid-cols-3 gap-2 mt-5'>
                        {
