    ...
    return (
        <div className="w-[90%] mx-auto my-20">
            ...
            <div className="grid lg:grid-cols-3 gap-3">
                <div>
                    <img className="w-96 mx-auto rounded-3xl ring" src="https://i.ibb.co/TcPpxHZ/young-smiling-man-bearded-businessman-pointing-with-two-finger-upward.jpg" />
                ...
                <div>
                    <div>
                        <img className="w-96 mx-auto rounded-3xl ring" src="https://i.ibb.co/hgkzsqt/young-bearded-man-with-striped-shirt.jpg"/>
                ...
                <div>
                    <div>
                        <img className="w-96 mx-auto rounded-3xl ring" src="https://i.ibb.co/pZkpZsP/portrait-handsome-young-man-with-crossed-arms.jpg" />
