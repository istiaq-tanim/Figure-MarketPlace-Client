...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 mt-24 bg-sky-200 text-base-content">

                <div className="flex flex-col lg:mx-auto justify-center">
                    <img className="h-16 lg:ml-5" src="https://i.ibb.co/JBZVh6R/wolverine-logo.png" alt="wolverine-logo" />
                    <span className='text-xl font-display font-bold tracking-wide text-gray-800'>
            ...
            <footer className="footer px-6 lg:px-32 py-4 border-t bg-sky-200 text-base-content border-sky-400">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - All right reserved by Figure Frontier</p>
                </div>
